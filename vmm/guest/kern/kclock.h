...
/* NVRAM bytes 38 39: extended memory >16M in blocks of 64K */
#define NVRAM_EXTGT16LO (MC_NVRAM_START + 38)   /* low byte. 0x34 */
#define NVRAM_EXTGT16HI (MC_NVRAM_START + 39)   /* high byte. 0x35 */
